...
!!! Défi_1: "Personnage mystère"
	[Personnage mystère](https://capytale2.ac-paris.fr/web/c/9d2d-1149747){: target = "_blank"}  


!!! Défi_2: "Clé endommagée"
	[clé endommagée](https://capytale2.ac-paris.fr/web/c/6aab-1078970){: target = "_blank"} 
