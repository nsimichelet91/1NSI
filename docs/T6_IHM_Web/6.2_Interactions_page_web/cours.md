		...
		<html>									
			...
			<body>	
				<div id="bloc_page">
					...
					<p><a href="http://pgdg.frama.io/1nsi">cours de 1NSI</a></p>
	...
	**Source HTML**
		```html	
			<html>									
				...
				<body>	
					<form action="https://pgdg.frama.io/1nsi" target="_blank" method="POST">
	...
	**Source HTML**
		```html	
			<html>									
				...
				<body>	
					<form id="formulaire" action="https://pgdg.frama.io/1nsi" target="_blank" method="POST">
