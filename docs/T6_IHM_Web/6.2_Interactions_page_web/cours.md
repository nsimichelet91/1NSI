		...
		<html>									
			...
			<body>	
				<div id="bloc_page">
					...
					<p><a href="https://developer.mozilla.org/fr/docs/Web">cours de 1NSI</a></p>
	...
	**Source HTML**
		```html	
			<html>									
				...
				<body>	
					<form action= "https://developer.mozilla.org/fr/docs/Web" target="_blank" method="POST">
	...
	**Source HTML**
		```html	
			<html>									
				...
				<body>	
					<form id="formulaire" action="https://developer.mozilla.org/fr/docs/Web" target="_blank" method="POST">
