...
Par exemple, l'appel au site ```https://developer.mozilla.org/fr/docs/Web``` génère une vingtaine requêtes/réponses différentes, composées de fichiers html, css, js, de fichiers de fontes woff2, d'images jpg, png...
